# makeTcr33.tcl: Build tcr33 from CHARMM-GUI output using 7FJD. 
# Fix the errors in HARMM-GUI output, tcr3,0 to make tcr33, which is wt TCR with 
# two structural cholesterols, PDB 7FJD.
...
[atomselect $tcr "segid HETB"] writepdb s2Chain.pdb
